...
xcodebuild -project "${PROJ_PATH}" -target "${PROJ_TARGET}" -configuration "${PROJ_CONFIG}" -sdk ${SDK_SIMULATOR} BUILD_DIR="${PROJ_BUILD_DIR}" OBJROOT="${PROJ_OBJROOT}" BUILD_ROOT="${PROJ_BUILD_ROOT}" CONFIGURATION_BUILD_DIR="${SIMULATOR_BUILD_DIR}" SYMROOT="${PROJ_SYMROOT}" ARCHS='x86_64' VALID_ARCHS='x86_64' ${PROJ_ACTION}
