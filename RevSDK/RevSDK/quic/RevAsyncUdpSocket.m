...
NSString *const RevAsyncUdpSocketException = @"AsyncUdpSocketException";
NSString *const RevAsyncUdpSocketErrorDomain = @"AsyncUdpSocketErrorDomain";
...
**/
@interface RevAsyncSendPacket : NSObject
{
@public
	NSData *buffer;
	NSData *address;
...
@implementation RevAsyncSendPacket
...
**/
@interface RevAsyncReceivePacket : NSObject
{
@public
	NSTimeInterval timeout;
	long tag;
...
@implementation RevAsyncReceivePacket
...
@implementation RevAsyncUdpSocket
...
- (BOOL)connectToHost:(NSString *)host onPort:(UInt16)port error:(NSError **)errPtr
{
	...
	{
		[NSException raise:RevAsyncUdpSocketException
...
- (NSError *)getSocketError
{
	...
	return [NSError errorWithDomain:RevAsyncUdpSocketErrorDomain code:AsyncUdpSocketCFSocketError userInfo:info];
}
...
- (NSError *)getIPv4UnavailableError
{
	...
	return [NSError errorWithDomain:RevAsyncUdpSocketErrorDomain code:AsyncUdpSocketIPv4Unavailable userInfo:info];
}
...
- (NSError *)getIPv6UnavailableError
{
	...
	return [NSError errorWithDomain:RevAsyncUdpSocketErrorDomain code:AsyncUdpSocketIPv6Unavailable userInfo:info];
}
...
- (NSError *)getSendTimeoutError
{
	...
	return [NSError errorWithDomain:RevAsyncUdpSocketErrorDomain code:AsyncUdpSocketSendTimeoutError userInfo:info];
}
- (NSError *)getReceiveTimeoutError
{
	...
	return [NSError errorWithDomain:RevAsyncUdpSocketErrorDomain code:AsyncUdpSocketReceiveTimeoutError userInfo:info];
}
...
- (BOOL)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	RevAsyncSendPacket *packet = [[RevAsyncSendPacket alloc] initWithData:data address:nil timeout:timeout tag:tag];
...
- (CFSocketRef)socketForPacket:(RevAsyncSendPacket *)packet
{
	if(!theSocket4)
		return theSocket6;
	if(!theSocket6)
...
- (void)receiveWithTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	RevAsyncReceivePacket *packet = [[RevAsyncReceivePacket alloc] initWithTimeout:timeout tag:tag];
