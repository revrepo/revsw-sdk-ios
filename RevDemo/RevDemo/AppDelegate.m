...
{
    // For the demonstration purposes, we'll disable NSURLCache
    // (or stats may look a bit confusing)
   ...
   // [RevSDK startWithSDKKey:@"42e276ea-1823-4945-baa4-8747f08d0abe"];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(10 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSString* str = @"http://www.youtube.com/_get_ads?ajax=1&dc_ref=http%3A%2F%2Fwww.youtube.com%2F&ipadtype=3&layout=tablet&tsp=1&utcoffset=120";
